      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="metric-card">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>Active Validators</h3>
          </div>
          <div className="text-3xl font-bold text-white mb-2">{currentProject.validator.totalValidators}</div>
          <div className="text-sm" style={{ color: currentProject.color }}>+2 since last login</div>
        </div>
        
        <div className="metric-card">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>Total Staked</h3>
          </div>
          <div className="text-3xl font-bold mb-2" style={{ color: currentProject.color }}>{currentProject.metrics.totalStaked}</div>
          <div className="text-sm" style={{ color: currentProject.color }}>+19% from last month</div>
        </div>
        
        <div className="metric-card">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>Active Delegations</h3>
          </div>
          <div className="text-3xl font-bold text-white mb-2">{currentProject.metrics.activeDelegations}</div>
          <div className="text-sm" style={{ color: currentProject.color }}>+201 since yesterday</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex space-x-2">
              <button className="px-3 py-1 rounded-md text-sm font-medium text-white" style={{ backgroundColor: currentProject.color }}>
                Monthly
              </button>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="text-center p-3 bg-[var(--bg-hover)] rounded-lg">
              ...
              <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Uptime</div>
            </div>
            <div className="text-center p-3 bg-[var(--bg-hover)] rounded-lg">
            ...
            <div className="text-center p-3 bg-[var(--bg-hover)] rounded-lg">
              ...
              <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>TPS</div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-[var(--border-color)]">
              <div className="flex justify-between items-center">
                <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Avg Block Size</span>
                <span className="text-sm text-white">2.1 MB</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Gas Price</span>
                <span className="text-sm text-white">15 Gwei</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Active Nodes</span>
                <span className="text-sm text-white">{currentProject.validator.totalValidators}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Network Hash</span>
        ...
        <div className="card">
          <div className="mb-6">
            ...
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>You made 265 transactions this month.</p>
          </div>
          
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 style={{ backgroundColor: currentProject.color }} rounded-full flex items-center justify-center">
                  <span className="text-white text-sm">↗</span>
                </div>
                <div>
                  <div className="text-white text-sm font-medium">{currentProject.network.currency.symbol}/USDT</div>
                  <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Stake</div>
                </div>
              </div>
              <div className="text-right">
                <div className="style={{ color: currentProject.color }} text-sm font-medium">+$3,540</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-white text-sm font-medium">{currentProject.network.currency.symbol}/USDT</div>
                  <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Delegate</div>
                </div>
              </div>
              <div className="text-right">
                <div className="style={{ color: currentProject.color }} text-sm font-medium">+$2,340</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-white text-sm font-medium">{currentProject.network.currency.symbol}/USDT</div>
                  <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Unstake</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-[#ff6b6b] text-sm font-medium">-$1,340</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-white text-sm font-medium">{currentProject.network.currency.symbol}/USDT</div>
                  <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Reward</div>
                </div>
              </div>
              <div className="text-right">
                <div className="style={{ color: currentProject.color }} text-sm font-medium">+$1,240</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div>
                ...
                <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Active Validator</div>
              </div>
              <div className="text-right">
                <div className="style={{ color: currentProject.color }} text-sm font-medium">+$5,240</div>
                <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Win Rate 87%</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              ...
              <div className="text-right">
                <div className="style={{ color: currentProject.color }} text-sm font-medium">+$3,980</div>
                <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Win Rate 92%</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              ...
              <div className="text-right">
                <div className="style={{ color: currentProject.color }} text-sm font-medium">+$2,340</div>
                <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Win Rate 98%</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>0.76 BTC</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-white text-sm font-medium">$32,400</div>
                <div className="style={{ color: currentProject.color }} text-xs">+12.5% ↗</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>2.14 ETH</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-white text-sm font-medium">$8,240</div>
                <div className="style={{ color: currentProject.color }} text-xs">+8.2% ↗</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>32.5 SOL</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-white text-sm font-medium">$3,450</div>
                <div className="style={{ color: currentProject.color }} text-xs">+24.1% ↗</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-hover)] rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Stablecoin</div>
                </div>
              </div>
              <div className="text-right">
